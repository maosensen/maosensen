...
<p align="center">
  <img src="https://raw.githubusercontent.com/maosensen/maosensen/main/assets/timeline.svg" width="100%" alt="Release timeline: 86 releases across 10 projects in the last 28 days, one lane per project.">
</p>

**86 releases in the last 28 days**, across 10 projects — 208 commits in the last 7. Every one of these is a real tagged release with a changelog, not a version bump.

## The matrix

| Project | Tags | Latest | Commits 7d | Main language |
|---|---|---|---|---|
| [yBlocks](https://github.com/maosensen/yBlocks) | `ui` `blocks` | `v0.61.0` | 114 | TypeScript |
| [yPulse](https://github.com/maosensen/yPulse) | `meta` `pipeline` | `v0.3.12` | 47 | TypeScript |
...
*This page rebuilds itself every day from [yPulse](https://github.com/maosensen/yPulse), my own project-matrix monitor — the release history, the language split and the feature counts all come from snapshots it collects. Last built 2026-08-26.*
