...
**99 releases in the last 28 days**, across 13 projects — 302 commits in the last 7. Every one of these is a real tagged release with a changelog, not a version bump.
...
| [yPulse](https://github.com/maosensen/yPulse) | `meta` `pipeline` | `v0.3.12` | 71 | TypeScript |
